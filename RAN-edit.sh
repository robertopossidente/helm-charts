...
#RUN 
#kubectl exec $RRU_POD -- sudo -E ./targets/bin/lte-softmodem.Rel14 -O ./ci-scripts/conf_files/rru.fdd.band7.conf --siml1 -r 25 --ue-txgain 0 --ue-scan-carrier --ue-rxgain 115 -U 1
#kubectl exec $RCC_POD -- sudo -E ./targets/bin/lte-softmodem.Rel14 -O ./ci-scripts/conf_files/rcc.band7.tm1.if4p5.lo.25PRB.usrpb210.conf 
